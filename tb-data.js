...
const ACCOUNTS = [
  ...
  },
  {
    ...
    "risk": "Valuation and disclosure rather than existence. The fair value hierarchy and the deposit and investment risk disclosures are where the work sits."
  },
  {
    "row": 13,
    "acct": 130,
  ...
  },
  {
    ...
    "risk": "A miscellaneous receivable with no named source. Materiality governs how far to take it, but the composition should still be understood."
  },
  {
    "row": 19,
    "acct": 1504,
  ...
  },
  {
    ...
    "risk": "A large balance under an unspecific name may hold items belonging elsewhere. Review the underlying detail."
  },
  {
    "row": 82,
    "acct": 2150,
...
const REASONING = [
  ...
  {
    "q": "Cash and Cash/Investments are separate classifications, but both file to lead reference 1010.00. Why keep them separate at all?",
    "options": [
      "The separation is a formatting artifact with no audit significance",
      "They share a workpaper but the testing diverges once the balance is confirmed",
      "Cash/Investments accounts are immaterial and get absorbed into cash",
      "The two will eventually be merged into a single classification"
    ],
    "a": 1,
    "why": "Confirming a balance looks the same for both. After that they part company: an investment carries a fair value that can move, a maturity date, and a counterparty, which brings valuation work and the deposit and investment risk disclosures that operating cash never triggers. Same lead, different procedures."
  },
  {
