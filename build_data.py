...
DESC = {
    ...
    120: ("Not Cash, because it carries a fair value that can move and a counterparty that can fail. Not filed with a pure investment lead either, because the entity treats it as available liquidity. The hybrid label is the trial balance placing it between the two.",
          "Valuation and disclosure rather than existence. The fair value hierarchy and the deposit and investment risk disclosures are where the work sits, and this area has no lead reference assigned."),
    ...
    1503: ("Revenue. Miscellaneous receivables still originate in a revenue transaction, and that origin is what determines the area.",
           "The largest proportional movement among the receivables, on a small base. Materiality governs the response, but the composition should still be understood."),
    ...
    2142: ("Expense. A general operating account carrying no further breakdown.",
           "An account of this size with an unspecific name may hold items belonging elsewhere. Review the underlying detail."),
